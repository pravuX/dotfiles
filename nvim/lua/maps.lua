...
map('', '<C-left>', '<Esc>:BufferLineCyclePrev<CR>' ,opts)
map('', '<C-right>', '<Esc>:BufferLineCycleNext<CR>' ,opts)
map('', '<C-S-left>', '<Esc>:BufferLineMovePrev<CR>' ,opts)
map('', '<C-S-right>', '<Esc>:BufferLineMoveNext<CR>' ,opts)
map('', '<C-p>', '<Esc>:BufferLinePick<CR>', opts)
map('', '<C-c>', '<Esc>:BufferLinePickClose<CR>', opts)
